...
if __name__ == '__main__':
    ...
    workspace = f"{os.path.dirname(os.path.dirname(__file__))}/PC414 CWI Million Acres LocalTesting.gdb"
    scratch_workspace = f"{os.path.dirname(os.path.dirname(__file__))}/scratch.gdb"
    
    for w in [workspace,scratch_workspace]:
        if not os.path.exists(w):
            print(f'Creating new FileGDB: {w}')
            arcpy.management.CreateFileGDB(os.path.dirname(__file__), os.path.basename(w))
