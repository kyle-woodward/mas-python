...
def aEnrichmentsPolygon1(enrich_out, enrich_in):  # 7a Enrichments Polygon
    ...
    # define intermediary outputs in scratch gdb
    Veg_Summarized_Polygons = os.path.join(scratch_workspace,'Veg_Summarized_Polygons') # define intermediary outputs in scratch gdb
    ...
    # define path to intermediary file in scratch gdb
