...
def CalTrans(input_pts, input_polys, output_lines_standardized, output_points_standardized, output_points_enriched, output_lines_enriched):  # 6m CalTrans_Activities 20221123
    ...
    Updated_Input_Table_11_ = arcpy.management.CalculateField(in_table=Updated_Input_Table_45_, 
                                                              field="IN_WUI", 
    ...
    Updated_Input_Table_12_ = arcpy.management.CalculateField(in_table=Updated_Input_Table_20_, 
                                                              field="ACTIVITY_UOM", 
                                                              expression="!Activity_Unit_of_Measure!", 
                                                              expression_type="PYTHON3", 
                                                              code_block="", 
                                                              field_type="TEXT", 
                                                              enforce_domains="NO_ENFORCE_DOMAINS")[0]
    ...
    Updated_Input_Table_16_ = arcpy.management.CalculateField(in_table=Updated_Input_Table_22_, 
                                                              field="Source", 
                                                              expression="\"CALTRANS\"", 
                                                              expression_type="PYTHON3", 
                                                              code_block="", 
    ...
    CalTrans_pts_Copy_16_ = arcpy.management.DeleteField(in_table=CalTrans_pts_Copy_7_, 
    ...
    Updated_Input_Table_36_ = arcpy.management.CalculateField(in_table=Updated_Input_Table_46_, 
                                                              field="IN_WUI", 
                                                              expression="ifelse(!WUI!)", 
                                                              expression_type="PYTHON3", 
                                                              code_block="""def ifelse(WUI):
    ...
    Updated_Input_Table_42_ = arcpy.management.CalculateField(in_table=Updated_Input_Table_41_, 
                                                              field="Source", 
                                                              expression="\"CALTRANS\"", 
                                                              expression_type="PYTHON3", 
                                                              code_block="", 
    ...
    CalTrans_pts_Copy_14_ = arcpy.management.DeleteField(in_table=CalTrans_pts_Copy_15_, 
                                                         drop_field=["PROJECTID_USER", 
                                                                     "AGENCY", 
                                                                     "ORG_ADMIN_p", 
                                                                     "PROJECT_CONTACT", 
