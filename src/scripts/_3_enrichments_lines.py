...
def enrich_lines(line_fc, delete_scratch=False): 
    with arcpy.EnvManager(
        ...
        Line_Enriched_Temp_CopyFeatures = arcpy.management.CreateFeatureclass(
            ...
            has_m="DISABLED",
            has_z="DISABLED",
            spatial_reference="NAD 1983 California (Teale) Albers (Meters)", #'PROJCS["NAD_1983_California_Teale_Albers",GEOGCS["GCS_North_American_1983",DATUM["D_North_American_1983",SPHEROID["GRS_1980",6378137.0,298.257222101]],PRIMEM["Greenwich",0.0],UNIT["Degree",0.0174532925199433]],PROJECTION["Albers"],PARAMETER["False_Easting",0.0],PARAMETER["False_Northing",-4000000.0],PARAMETER["Central_Meridian",-120.0],PARAMETER["Standard_Parallel_1",34.0],PARAMETER["Standard_Parallel_2",40.5],PARAMETER["Latitude_Of_Origin",0.0],UNIT["Meter",1.0]];-16909700 -8597000 10000;#;#;0.001;#;#;IsHighPrecision',
            config_keyword="",
            spatial_grid_1=0,
            spatial_grid_2=0,
            spatial_grid_3=0,
