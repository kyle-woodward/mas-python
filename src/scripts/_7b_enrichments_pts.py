...
def enrich_points(
    ...
    CPAD_Ownership_Update = os.path.join(
        workspace, "b_Reference", "CPAD_Ownership_Update"
    )
    ...
    if Treatments_Merge3_California_5_:
        arcpy.analysis.SpatialJoin(
            target_features=Pts_enrichment_copy,
    ...
    if Treatments_Merge3_California_5_:
        arcpy.analysis.SpatialJoin(
            target_features=Pts_enrichment_RCD,
    ...
    if Treatments_Merge3_California_5_:
        Veg_Summarized_Polygons_Laye_3_ = arcpy.management.CalculateField(
    ...
    if Treatments_Merge3_California_5_:
        Veg_Summarized_Polygons_Laye_4_ = arcpy.management.CalculateField(
...
""",
    ...
    if Treatments_Merge3_California_5_:
        Veg_Summarized_Polygons_Laye_6_ = arcpy.management.CalculateField(
            in_table=Veg_Summarized_Polygons_Laye_4_,
            field="REGION",
    ...
    if Treatments_Merge3_California_5_:
        Veg_Summarized_Polygons_Laye_2_ = arcpy.management.CalculateField(
            in_table=Veg_Summarized_Polygons_Laye_6_,
    ...
    if Pts_enrichment_Veg_2_ and Treatments_Merge3_California_5_:
        Pts_enrichment_Veg_Layer = arcpy.management.AddJoin(
            in_layer_or_view=Pts_enrichment_Veg,
            in_field="Crosswalk",
    ...
    if Pts_enrichment_Veg_2_ and Treatments_Merge3_California_5_:
        Pts_enrichment_Veg_Layer_4_ = arcpy.management.SelectLayerByAttribute(
            in_layer_or_view=Pts_enrichment_Veg_Layer,
    ...
    if Pts_enrichment_Veg_2_ and Treatments_Merge3_California_5_:
        Updated_Input_Table_3_ = arcpy.management.CalculateField(
            ...
            field="Pts_enrichment_Veg.ACTIVITY_DESCRIPTION",
        ...
        Updated_Input_Table_4_ = arcpy.management.SelectLayerByAttribute(
            in_layer_or_view=Updated_Input_Table_3_, selection_type="CLEAR_SELECTION"
        )
    ...
    if Pts_enrichment_Veg_2_ and Treatments_Merge3_California_5_:
        Veg_Summarized_Polygons_Laye3_4_ = arcpy.management.CalculateField(
            in_table=Veg_Summarized_Polygons_Laye3_3_,
            field="Pts_enrichment_Veg.RESIDUE_FATE",
    ...
    if Pts_enrichment_Veg_2_ and Treatments_Merge3_California_5_:
        Veg_Summarized_Polygons_Laye3_5_ = Residue(
            Input_Table=Veg_Summarized_Polygons_Laye3_4_
        )

    # Process: Select Layer By Attribute (Select Layer By Attribute) (management)
    if Pts_enrichment_Veg_2_ and Treatments_Merge3_California_5_:
        Pts_enrichment_Veg_Layer_3_ = arcpy.management.SelectLayerByAttribute(
            in_layer_or_view=Veg_Summarized_Polygons_Laye3_5_,
            selection_type="NEW_SELECTION",
    ...
    if Pts_enrichment_Veg_2_ and Treatments_Merge3_California_5_:
        Updated_Input_Table_5_ = arcpy.management.CalculateField(
            in_table=Pts_enrichment_Veg_Layer_3_,
            field="Pts_enrichment_Veg.PRIMARY_OBJECTIVE",
    ...
    if Pts_enrichment_Veg_2_ and Treatments_Merge3_California_5_:
        Pts_enrichment_Veg_Layer_5_ = arcpy.management.SelectLayerByAttribute(
    ...
    if Pts_enrichment_Veg_2_ and Treatments_Merge3_California_5_:
        Pts_enrichment_Veg_Layer_2_ = arcpy.management.RemoveJoin(
            in_layer_or_view=Pts_enrichment_Veg_Layer_5_,
    ...
    Pts_enrichment_Veg_Layer3 = arcpy.management.CalculateGeometryAttributes(
        in_features=Pts_enrichment_Veg_Layer2,
        geometry_property=[
    ...
    if Pts_enrichment_Veg_2_ and Treatments_Merge3_California_5_:
        arcpy.analysis.Select(
            in_features=Pts_enrichment_Veg_Layer4,
