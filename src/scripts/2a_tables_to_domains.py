...
def TablesToDomains(D_workspace):  # 2a Tables to Domains
    ...
    domain_table = os.path.join(
        os.path.dirname(os.path.dirname(__file__)), "Domain Tables 20230414.xlsx"
    )
    ...
    PC414_CWI_Million_Acres_gdb = arcpy.management.TableToDomain(
        in_table=D_VERFIEDMSG_,
        code_field="CODE",
        description_field="Descr",
        in_workspace=D_workspace,
    ...
    PC414_CWI_Million_Acres_gdb_3_ = arcpy.management.TableToDomain(
    ...
    PC414_CWI_Million_Acres_gdb_4_ = arcpy.management.TableToDomain(
    ...
    PC414_CWI_Million_Acres_gdb_5_ = arcpy.management.TableToDomain(
        in_table=D_STATUS_,
        code_field="CODE",
        description_field="Descr",
        in_workspace=D_workspace,
    ...
    PC414_CWI_Million_Acres_gdb_6_ = arcpy.management.TableToDomain(
        in_table=D_CNTY_,
        code_field="CODE",
        description_field="Descr",
        in_workspace=D_workspace,
    ...
    PC414_CWI_Million_Acres_gdb_7_ = arcpy.management.TableToDomain(
        in_table=D_IN_WUI_,
        code_field="CODE",
        description_field="Descr",
        in_workspace=D_workspace,
    ...
    PC414_CWI_Million_Acres_gdb_8_ = arcpy.management.TableToDomain(
    ...
    PC414_CWI_Million_Acres_gdb_9_ = arcpy.management.TableToDomain(
        in_table=D_ACTVCAT_,
        code_field="CODE",
        description_field="Descr",
        in_workspace=D_workspace,
    ...
    PC414_CWI_Million_Acres_gdb_10_ = arcpy.management.TableToDomain(
        in_table=D_BVT_,
        code_field="CODE",
        description_field="Descr",
        in_workspace=D_workspace,
    ...
    PC414_CWI_Million_Acres_gdb_11_ = arcpy.management.TableToDomain(
    ...
    PC414_CWI_Million_Acres_gdb_12_ = arcpy.management.TableToDomain(
        in_table=D_UOM_,
        code_field="CODE",
        description_field="Descr",
        in_workspace=D_workspace,
    ...
    PC414_CWI_Million_Acres_gdb_13_ = arcpy.management.TableToDomain(
    ...
    PC414_CWI_Million_Acres_gdb_14_ = arcpy.management.TableToDomain(
    ...
    PC414_CWI_Million_Acres_gdb_15_ = arcpy.management.TableToDomain(
        in_table=D_FNDSRC_,
        code_field="CODE",
        description_field="Descr",
        in_workspace=D_workspace,
    ...
    PC414_CWI_Million_Acres_gdb_16_ = arcpy.management.TableToDomain(
        in_table=D_AGENCY_,
        code_field="CODE",
        description_field="Descr",
        in_workspace=D_workspace,
    ...
    PC414_CWI_Million_Acres_gdb_16_ = arcpy.management.TableToDomain(
        ...
        domain_description="Organization",
        update_option="REPLACE",
    )

    # Process: Table To Date Status Domain (Table To Domain) (management)
    PC414_CWI_Million_Acres_gdb_17_ = arcpy.management.TableToDomain(
    ...
    PC414_CWI_Million_Acres_gdb_18_ = arcpy.management.TableToDomain(
        in_table=D_DATAMSG_,
        code_field="CODE",
        description_field="Descr",
        in_workspace=D_workspace,
    ...
    # Process: Table To Data Load Domain (Table To Domain) (management)
    PC414_CWI_Million_Acres_gdb_19_ = arcpy.management.TableToDomain(
        in_table=D_TRMT_GEOM,
        code_field="CODE",
        description_field="Descr",
        in_workspace=D_workspace,
        domain_name="D_DATAMSG",
