...
def enrich_polygons(
    ...
    with arcpy.EnvManager(
        ...
        RasterT_Reclass_WUI = os.path.join(
            workspace, "b_Reference", "RasterT_Reclass_WUI"
        )
        CPAD_Ownership_Update = os.path.join(
            workspace, "b_Reference", "CPAD_Ownership_Update"
        )
        WFRTF_Regions_Draft = os.path.join(workspace, "b_Reference", "WFRTF_Regions")
        ...
        Layer_With_Join_Removed = arcpy.management.RemoveJoin(
            in_layer_or_view=Updated_Input_Table_4_, join_name="WHR13NAME_Summary_temp"
        )
        ...
        (
            Treatments_Merge3_California_5_,
            Count_4_,
        ) = arcpy.management.SelectLayerByAttribute(
        ...
        Pts_enrichment_Veg_Layer_4_ = arcpy.management.SelectLayerByAttribute(
            in_layer_or_view=Veg_Summarized_Polygons_Laye4,
        ...
        Veg_Summarized_Polygons_Laye3_3_ = Residue(
            Input_Table=usfs_edw_facts_common_attrib1
        )
        ...
        (
            Veg_Summarized_Polygons_Laye_9_,
            Count_3_,
        ) = arcpy.management.SelectLayerByAttribute(
        ...
        (
            Veg_Summarized_Polygons_Laye_10_,
            Count_7_,
        ) = arcpy.management.SelectLayerByAttribute(
