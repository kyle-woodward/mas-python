...
# 6m CalTrans_Activities 2023711
...
def CalTrans(input_polys21, input_polys22, input_table21, input_table22, output_lines_standardized, output_lines_enriched):  
    ...
    caltrans_poly_copy_repaired_geom = arcpy.management.RepairGeometry(in_features=caltrans_poly_copy, 
    ...
    caltrans_poly_alterfield_v3 = arcpy.management.AlterField(in_table=caltrans_poly_alterfield_v2, 
    ...
    caltrans_poly_alterfield_v4 = arcpy.management.AlterField(in_table=caltrans_poly_alterfield_v3, 
    ...
    caltrans_poly_alterfield_v5 = arcpy.management.AlterField(in_table=caltrans_poly_alterfield_v4, 
    ...
    caltrans_poly_alterfield_v6 = arcpy.management.AlterField(in_table=caltrans_poly_alterfield_v5, 
                                                        field="Residue_Fate", 
                                                        new_field_name="Fate", 
                                                        new_field_alias="", 
                                                        field_type="TEXT", 
    ...
    caltrans_poly_alterfield_v7 = arcpy.management.AlterField(in_table=caltrans_poly_alterfield_v6, 
    ...
    caltrans_poly_alterfield_v8 = arcpy.management.AlterField(in_table=caltrans_poly_alterfield_v7, 
    ...
    caltrans_poly_calc_field_v11 = arcpy.management.CalculateField(in_table=caltrans_poly_calc_field_v10, 
                                                                      field="ACTIVID_USER", 
