...
def Crosswalk(Input_Table):  # 2l Crosswalk
    ...
    add_join_w_xwalk = arcpy.management.AddJoin(in_layer_or_view=Input_Table, 
                                                      in_field="Crosswalk", 
    ...
    select_tbd_objective = arcpy.management.SelectLayerByAttribute(in_layer_or_view=xwalk_residue_fate, 
